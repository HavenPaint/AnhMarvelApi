...
class AdaptadorRecyclerPersonajes(private val items: List<Personaje>, private val listener: OnItemClickListener) :
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        Picasso.get().load(item.thumbnail.devolverURLCompleta()).fit().centerCrop()
            .into(holder.recyclerFoto)
